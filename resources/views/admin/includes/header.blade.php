    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-navigation">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="{{ route("admin.itemcategories") }}" class="navbar-nav-link {{ Request::is('admin/itemcategories') ? 'active' : '' }}">
                ...
                @role("Restaurant Owner")
                <li class="nav-item">
                    <a href="{{ route("restaurant.itemcategories") }}" class="navbar-nav-link {{ Request::is('restaurant-owner/itemcategories') ? 'active' : '' }}">
                    <i class="icon-grid52 mr-2"></i>
                    Categories
                    </a>
                </li>
