                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified">
                                    ...
                                    @if($item->is_active)
                                    <a href="{{ route('admin.disableItem', $item->id) }}" class="badge badge-primary badge-icon ml-1" data-popup="tooltip" title="Disable Item" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                    @else
                                    <a href="{{ route('admin.disableItem', $item->id) }}" class="badge badge-primary badge-icon ml-1" data-popup="tooltip" title="Enable Item" data-placement="bottom" style="background-color: #FF5722"> <i class="icon-switch2"></i> </a>
                                    @endif
                                </div>
                            </td>
                        </tr>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.saveNewItem') }}" method="POST" enctype="multipart/form-data" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <textarea class="summernote-editor" name="desc" placeholder="Item Description" rows="6"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="uploader">
                                ...
                                <span class="help-text text-muted">Image sizes: 162x118 or 324x237 or 486x355 and so on. (For best quality use 486x355)</span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
