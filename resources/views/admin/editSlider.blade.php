    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-circle-right2 mr-2"></i>
                ...
                <span class="badge badge-primary badge-pill animated flipInX">{{ $slider->name }} - @if($slider->location_id != 0) $slider->location->name @else ALL LOCATIONS @endif</span>
            </h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-2">
                        ...
                        <div class="btn-group btn-group-justified" style="width: 150px">
                            ...
                            @else
                            <a href="{{ route('admin.disableSlide', $slide->id) }}" class="btn btn-secondary" data-popup="tooltip" title="Enable Slide" data-placement="bottom"> <i class="icon-switch2 ml-1"></i> </a>
                            @endif
                        </div>
                    </div>
                    @endforeach
