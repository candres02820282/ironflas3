                    ...
                    <fieldset class="gllpLatlonPicker mt-5">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control form-control-lg gllpLatitude latitude" value="40.6976701" name="latitude" placeholder="Latitude of the place" required="required" readonly="readonly">
                            </div>
                            <div class="col-lg-6">
                                <label class="col-lg-3 col-form-label">Longitude:</label>
                                <input type="text" class="form-control form-control-lg gllpLongitude longitude" value="-74.2598672" name="longitude" placeholder="Longitude of the place" required="required" readonly="readonly">
                            </div>
                        </div>
